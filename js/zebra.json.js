var JSONConfig = {
    ...
    "Slider": {
        ...
        "views" : {
             ...
             "hbundle": { "$Picture": [ "@pictures.zebra", 0,48,32,32 ] },
             "vbundle": { "$Picture": [ "@pictures.zebra", 0,48,32,32 ] }
        },
    ...
    "Menubar": {
        ...
        "background" : [ [ "#DCF0F7", { "$Gradient":["rgba(235, 235, 235, 0.8)", "rgba(255, 255, 255, 0.0)"] } ] ] ,
        "padding"   : [0,0,0,0],
        "layout"     : { "$FlowLayout": 0 },
        "views"      : {
